...
namespace starwars_api_net_core.Migrations
{
    ...
    [Migration("20200528120205_StarshipsFilms")]
    partial class StarshipsFilms
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("starwars_api_net_core.Models.Starship", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("MaxAtmospheringSpeed")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("starwars_api_net_core.Models.StarshipsFilms", b =>
                {
                    b.Property<Guid>("FilmId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("StarshipsFilms");
                });

            modelBuilder.Entity("starwars_api_net_core.Models.Vehicle", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<double>("MaxAtmosphericSpeed")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("starwars_api_net_core.Models.VehicleFilm", b =>
                {
                    b.Property<Guid>("FilmId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VehicleFilm");
                });

            modelBuilder.Entity("starwars_api_net_core.Models.VehiclePilot", b =>
                {
                    b.Property<Guid>("VehicleId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("VehicleId", "PeopleId");

                    b.HasIndex("PeopleId");

                    b.ToTable("VehiclePilot");
                });
            ...
            modelBuilder.Entity("starwars_api_net_core.Models.StarshipsFilms", b =>
                {
                    ...
                    b.HasOne("starwars_api_net_core.Models.Starship", "Starship")
                        .WithMany("Films")
            ...
            modelBuilder.Entity("starwars_api_net_core.Models.VehicleFilm", b =>
                {
                    ...
                    b.HasOne("starwars_api_net_core.Models.Vehicle", "Vehicle")
                        .WithMany("Films")
